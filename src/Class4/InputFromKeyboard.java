...
public class InputFromKeyboard {
	...
	public static void main(String[] args) {
		/*Scanner is a class that help us take the input from the
		 * keyboard, it contains many different smaller modules called methods that can help
